...
ActiveRecord::Schema[7.1].define(version: 2023_11_20_164505) do
  ...
  create_table "answer_choices", force: :cascade do |t|
    ...
    t.index ["questions_id"], name: "index_answer_choices_on_questions_id"
  end
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["polls_id"], name: "index_questions_on_polls_id"
  end
  ...
  add_foreign_key "answer_choices", "questions", column: "questions_id"
  add_foreign_key "polls", "users"
  add_foreign_key "questions", "polls", column: "polls_id"
